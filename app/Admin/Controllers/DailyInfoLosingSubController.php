...
class DailyInfoLosingSubController extends AdminController
{
    /**
    ...
    protected function grid()
    {
        ...
        if (Admin::user()->isRole('administrator') || Admin::user()->isRole('master')) {
            ...
            if ($admin_role_slug === 'sub_company') {
        ...
        $grid->column('하부갯수')->display(function (){
            $cnt = Recommend::where('step2_id', $this->id)->count();
            return $cnt;
        });
